			...
			<div className="custom-tab-1">
				...
				<ul className="nav nav-tabs" role="tablist">
					<li className="nav-item" role="presentation">
						<a className="nav-link" data-bs-toggle="tab" href="./index.html#notes" aria-selected="false" tabindex="-1" role="tab">Notes</a>
					</li>
					<li className="nav-item" role="presentation">
						<a className="nav-link" data-bs-toggle="tab" href="./index.html#alerts" aria-selected="false" tabindex="-1" role="tab">Alerts</a>
					</li>
					<li className="nav-item" role="presentation">
						<a className="nav-link active" data-bs-toggle="tab" href="./index.html#chat" aria-selected="true" role="tab">Chat</a>
					</li>
				</ul>
				<div className="tab-content">
					<div className="tab-pane fade active show" id="chat" role="tabpanel">
						...
						<div className="card chat dz-chat-history-box d-none">
							...
							<div className="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3" style={{height: "597px"}}>
