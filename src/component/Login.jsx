			...
			<div class="bg-img-fix overflow-hidden" style={{background:"#fff url(images/background/bg6.jpg)", height: "100vh"}}>
				<div class="row gx-0">
					<div class="col-xl-4 col-lg-5 col-md-6 col-sm-12 vh-100 bg-white ">
						<div id="mCSB_1" class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside" style={{maxHeight: "653px", tabindex:"0"}}>
								...
								<div class="login-form style-2">
									...
									<div class="card-body">
										<div class="logo-header">
											<a href="https://w3crm.dexignzone.com/xhtml/index.html" class="logo"><img src="../images/logo-full.png" alt="" class="width-230 light-logo"/></a>
											<a href="https://w3crm.dexignzone.com/xhtml/index.html" class="logo"><img src="../images/logofull-white.png" alt="" class="width-230 dark-logo"/></a>
										</div>
										...
										<div class="tab-content w-100" id="nav-tabContent">
										  <div class="tab-pane fade show active" id="nav-personal" role="tabpanel" aria-labelledby="nav-personal-tab">
											<form action="https://w3crm.dexignzone.com/xhtml/index.html" class=" dz-form pb-3">
													...
													<div class="form-group text-left mb-5 forget-main">
														...
														<button class="nav-link m-auto btn tp-btn-light btn-primary forget-tab " id="nav-forget-tab" data-bs-toggle="tab" data-bs-target="#nav-forget" type="button" role="tab" aria-controls="nav-forget" aria-selected="false" tabindex="-1">Forget Password ?</button> 	
													</div>
													<div class="dz-social ">
												...
												<div class="text-center bottom"> 
													<button class="btn btn-primary button-md btn-block" id="nav-sign-tab" data-bs-toggle="tab" data-bs-target="#nav-sign" type="button" role="tab" aria-controls="nav-sign" aria-selected="false" tabindex="-1">Create an account</button> 
										  ...
										  <div class="tab-pane fade" id="nav-sign" role="tabpanel" aria-labelledby="nav-sign-tab">
											<form class="dz-form py-2">
												...
												<div class="form-group clearfix text-left">
													<button class="btn btn-primary outline gray" data-bs-toggle="tab" data-bs-target="#nav-personal" type="button" role="tab" aria-controls="nav-personal" aria-selected="false" tabindex="-1">Back</button>
													<button class="btn btn-primary float-end">Submit</button>
												</div>
											</form>
							...
							<div id="mCSB_1_scrollbar_vertical" class="mCSB_scrollTools mCSB_1_scrollbar mCS-light mCSB_scrollTools_vertical" style={{display: "block"}}>
								...
								{/*<div id="mCSB_1_dragger_vertical" class="mCSB_dragger" style={{position: "absolute", minHheight: "0px", display: "block", height: "652px", maxHheight: "643px", top: "0px"}}>
